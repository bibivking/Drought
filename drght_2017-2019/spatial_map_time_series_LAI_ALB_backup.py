...
def plot_LAI(LAI_obs_path, LAI_one_path, LAI_two_path, LIS_PFT_file, wrf_path, time_s, time_e, LAI_types=["obs","modis_clim","modis_clim"],PFT=True,message=None):
    ...
    if 1:
        ...
        plt.savefig('./plots/time_series_LAI_climatology.png',dpi=300)
    ...
    if 1:
        ...
        label_x = ["LAI$\mathregular{_{obs}}$",
                    "LAI$\mathregular{_{clim-obs}}$",
                    "ΔLAI$\mathregular{_{1416-clim}}$",]
        ...
        if message != None:
            plt.savefig('./plots/spatial_map_LAI_'+message+'_compare_2017_2019.png',dpi=300)
        else:
...
def plot_ALBEDO(ALB_obs_paths, ALB_one_path, ALB_two_path, LIS_PFT_file, wrf_path, time_s, time_e, , loc_lat=None, loc_lon=None, lat_name="lat", lon_name="lon", ALB_types=["obs","modis_clim","modis_clim"],PFT=True,message=None):
    ...
    ALB_obs       = read_ALBEDO(ALB_obs_paths,ALB_types[0],year_s,year_e,time_s,time_e)
    ...
    if PFT:
        ...
        print("np.shape(PFT_obs)=",np.shape(PFT_obs))
        print("np.shape(PFT_one)=",np.shape(PFT_one))
    ...
    if 1:
        ...
        label_x = ["ALB$\mathregular{_{obs}}$",
                    "ALB$\mathregular{_{clim-obs}}$",
                    "ΔALB$\mathregular{_{1416-clim}}$",]
        ...
        ax[2].set_title(label_x[2])#,labelpad=-0.1)#, fontsize=12)
        if message != None:
            plt.savefig('./plots/spatial_map_ALB_'+message+'_2017_2019_compare.png',dpi=300)
        else:
...
if __name__ == "__main__":
    ...
    if 1:
        ...
        if 0:
            ...
            LAI_one_path  = [ path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201702-201702.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201703-201703.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201704-201704.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201705-201705.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201706-201706.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201707-201707.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201708-201708.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201709-201709.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201710-201710.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201711-201711.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201712-201712.d01.nc",]
                            # "/g/data/w97/mm3972/model/wrf/NUWRF/LISWRF_configs/Tinderbox_drght_LAI_ALB_before_Mar2023/drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/LIS.CABLE.201701-202006_ALB_LAI.nc"

            LAI_two_path  = [ path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201702-201702.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201703-201703.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201704-201704.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201705-201705.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201706-201706.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201707-201707.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201708-201708.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201709-201709.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201710-201710.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201711-201711.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201712-201712.d01.nc",]
                            #"/g/data/w97/mm3972/model/wrf/NUWRF/LISWRF_configs/Tinderbox_drght_LAI_ALB_before_Mar2023/drght_2017_2019_bl_pbl2_mp4_sf_sfclay2/LIS_output/LIS.CABLE.201701-202006_ALB_LAI.nc"
            LIS_PFT_file  = "/g/data/w97/mm3972/model/wrf/NUWRF/LISWRF_configs/Tinderbox_drght_LAI_ALB/drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/LIS.CABLE.201707-201707.d01.nc"
            wrf_path      = "/g/data/w97/mm3972/model/wrf/NUWRF/LISWRF_configs/Tinderbox_drght_LAI_ALB/drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/WRF_output/wrfout_d01_2017-01-01_11:00:00"

            time_s        = datetime(2017,1,1,0,0,0,0)
            time_e        = datetime(2019,12,31,23,59,0,0)

            message       = "obs_new_ctl_alb-lai"

            plot_LAI( LAI_obs_path, LAI_one_path, LAI_two_path, LIS_PFT_file, wrf_path, time_s, time_e, LAI_types,PFT=True)
        ...
        if 1:
            ...
            path          = "/g/data/w97/mm3972/model/wrf/NUWRF/LISWRF_configs/Tinderbox_drght_LAI_ALB/"
            ALB_one_path  = [ path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201702-201702.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201703-201703.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201704-201704.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201705-201705.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2/LIS_output/"+"LIS.CABLE.201706-201706.d01.nc",
            ...
            ALB_two_path  = [ path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201702-201702.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201703-201703.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201704-201704.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201705-201705.d01.nc",
                            path+"drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI_ALB/LIS_output/"+"LIS.CABLE.201706-201706.d01.nc",
            ...
            plot_ALBEDO(ALB_obs_paths, ALB_one_path, ALB_two_path, LIS_PFT_file, wrf_path, time_s, time_e, loc_lat=loc_lat, loc_lon=loc_lon,
                                  lat_name=lat_name, lon_name=lon_name, ALB_types=ALB_types,PFT=True,message=message)
    ...
    if 0:
        ...
        if 0:
            "LAI"
            LIS_PFT_file  = "/g/data/w97/mm3972/model/wrf/NUWRF/LISWRF_configs/drght_2017_2019_bl_pbl2_mp4_ra5_sf_sfclay2_obs_LAI/LIS_output/LIS.CABLE.201707-201707.d01.nc"
