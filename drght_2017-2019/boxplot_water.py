...
if __name__ == "__main__":
    ...
    if 1:
        ...
        file_paths_ctl = [ LIS_path_ctl+"LIS.CABLE.201701-202006_water.nc" ]

        file_paths_sen = [ LIS_path_sen+"LIS.CABLE.201701-202006_water.nc" ]

        file_paths_sen_2=None

        # =============== save pixels  ================
        if 1:
            var_names      = [ "Evap_tavg","Rainf_tavg","TVeg_tavg","ESoil_tavg"] # water
                            # [ "Qh_tavg","Qle_tavg","EF",] # energy
                            # ["AvgSurfT_tavg","VegT_tavg"] # temperature
                            # ["Tair_f_inst","Wind_f_inst","Qair_f_inst","Psurf_f_inst","SWdown_f_inst","LWdown_f_inst"] #met
