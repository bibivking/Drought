...
def plot_time_series_burn_unburn_region(FMI_file, Tmax_file, LAI_file, ALB_file, Qle_file,
    ...
    df_reg1['Qle_ctl_mean']  = Qle_mean_ctl[0,:]
    df_reg1['Qle_sen_mean']  = Qle_mean_sen[0,:]
    ...
    df_reg1['Qle_ctl_low']   = Qle_mean_ctl[0,:] - Qle_std_ctl[0,:]
    df_reg1['Qle_ctl_high']  = Qle_mean_ctl[0,:] + Qle_std_ctl[0,:]
    df_reg1['Qle_sen_low']   = Qle_mean_sen[0,:] - Qle_std_sen[0,:]
    df_reg1['Qle_sen_high']  = Qle_mean_sen[0,:] + Qle_std_sen[0,:]
    ...
    df_reg2['Qle_ctl_mean']  = Qle_mean_ctl[1,:]
    df_reg2['Qle_sen_mean']  = Qle_mean_sen[1,:]
    ...
    df_reg2['Qle_ctl_low'] = Qle_mean_ctl[1,:] - Qle_std_ctl[1,:]
    df_reg2['Qle_ctl_high']= Qle_mean_ctl[1,:] + Qle_std_ctl[1,:]
    df_reg2['Qle_sen_low'] = Qle_mean_sen[1,:] - Qle_std_sen[1,:]
    df_reg2['Qle_sen_high']= Qle_mean_sen[1,:] + Qle_std_sen[1,:]
    ...
    df_reg3['Qle_ctl_mean']  = Qle_mean_ctl[2,:]
    df_reg3['Qle_sen_mean']  = Qle_mean_sen[2,:]
    ...
    df_reg3['Qle_ctl_low'] = Qle_mean_ctl[2,:] - Qle_std_ctl[2,:]
    df_reg3['Qle_ctl_high']= Qle_mean_ctl[2,:] + Qle_std_ctl[2,:]
    df_reg3['Qle_sen_low'] = Qle_mean_sen[2,:] - Qle_std_sen[2,:]
    df_reg3['Qle_sen_high']= Qle_mean_sen[2,:] + Qle_std_sen[2,:]
    ...
    df_reg1_unburnt['LAI_ctl_mean']  = LAI_mean_ctl_unburnt[0,:]
    df_reg1_unburnt['LAI_sen_mean']  = LAI_mean_sen_unburnt[0,:]
    df_reg1_unburnt['ALB_ctl_mean']  = ALB_mean_ctl_unburnt[0,:]
    df_reg1_unburnt['ALB_sen_mean']  = ALB_mean_sen_unburnt[0,:]
    df_reg1_unburnt['Qle_ctl_mean']  = Qle_mean_ctl_unburnt[0,:]
    df_reg1_unburnt['Qle_sen_mean']  = Qle_mean_sen_unburnt[0,:]
    df_reg1_unburnt['LAI_ctl_low']   = LAI_mean_ctl_unburnt[0,:] - LAI_std_ctl_unburnt[0,:]
    df_reg1_unburnt['LAI_ctl_high']  = LAI_mean_ctl_unburnt[0,:] + LAI_std_ctl_unburnt[0,:]
    df_reg1_unburnt['LAI_sen_low']   = LAI_mean_sen_unburnt[0,:] - LAI_std_sen_unburnt[0,:]
    df_reg1_unburnt['LAI_sen_high']  = LAI_mean_sen_unburnt[0,:] + LAI_std_sen_unburnt[0,:]
    df_reg1_unburnt['ALB_ctl_low']   = ALB_mean_ctl_unburnt[0,:] - ALB_std_ctl_unburnt[0,:]
    df_reg1_unburnt['ALB_ctl_high']  = ALB_mean_ctl_unburnt[0,:] + ALB_std_ctl_unburnt[0,:]
    df_reg1_unburnt['ALB_sen_low']   = ALB_mean_sen_unburnt[0,:] - ALB_std_sen_unburnt[0,:]
    df_reg1_unburnt['ALB_sen_high']  = ALB_mean_sen_unburnt[0,:] + ALB_std_sen_unburnt[0,:]
    df_reg1_unburnt['Qle_ctl_low']   = Qle_mean_ctl_unburnt[0,:] - Qle_std_ctl_unburnt[0,:]
    df_reg1_unburnt['Qle_ctl_high']  = Qle_mean_ctl_unburnt[0,:] + Qle_std_ctl_unburnt[0,:]
    df_reg1_unburnt['Qle_sen_low']   = Qle_mean_sen_unburnt[0,:] - Qle_std_sen_unburnt[0,:]
    df_reg1_unburnt['Qle_sen_high']  = Qle_mean_sen_unburnt[0,:] + Qle_std_sen_unburnt[0,:]
    ...
    df_reg2_unburnt['LAI_ctl_mean']  = LAI_mean_ctl_unburnt[1,:]
    df_reg2_unburnt['LAI_sen_mean']  = LAI_mean_sen_unburnt[1,:]
    df_reg2_unburnt['ALB_ctl_mean']  = ALB_mean_ctl_unburnt[1,:]
    df_reg2_unburnt['ALB_sen_mean']  = ALB_mean_sen_unburnt[1,:]
    df_reg2_unburnt['Qle_ctl_mean']  = Qle_mean_ctl_unburnt[1,:]
    df_reg2_unburnt['Qle_sen_mean']  = Qle_mean_sen_unburnt[1,:]
    df_reg2_unburnt['LAI_ctl_low']   = LAI_mean_ctl_unburnt[1,:] - LAI_std_ctl_unburnt[1,:]
    df_reg2_unburnt['LAI_ctl_high']  = LAI_mean_ctl_unburnt[1,:] + LAI_std_ctl_unburnt[1,:]
    df_reg2_unburnt['LAI_sen_low']   = LAI_mean_sen_unburnt[1,:] - LAI_std_sen_unburnt[1,:]
    df_reg2_unburnt['LAI_sen_high']  = LAI_mean_sen_unburnt[1,:] + LAI_std_sen_unburnt[1,:]
    df_reg2_unburnt['ALB_ctl_low']   = ALB_mean_ctl_unburnt[1,:] - ALB_std_ctl_unburnt[1,:]
    df_reg2_unburnt['ALB_ctl_high']  = ALB_mean_ctl_unburnt[1,:] + ALB_std_ctl_unburnt[1,:]
    df_reg2_unburnt['ALB_sen_low']   = ALB_mean_sen_unburnt[1,:] - ALB_std_sen_unburnt[1,:]
    df_reg2_unburnt['ALB_sen_high']  = ALB_mean_sen_unburnt[1,:] + ALB_std_sen_unburnt[1,:]
    df_reg2_unburnt['Qle_ctl_low']   = Qle_mean_ctl_unburnt[1,:] - Qle_std_ctl_unburnt[1,:]
    df_reg2_unburnt['Qle_ctl_high']  = Qle_mean_ctl_unburnt[1,:] + Qle_std_ctl_unburnt[1,:]
    df_reg2_unburnt['Qle_sen_low']   = Qle_mean_sen_unburnt[1,:] - Qle_std_sen_unburnt[1,:]
    df_reg2_unburnt['Qle_sen_high']  = Qle_mean_sen_unburnt[1,:] + Qle_std_sen_unburnt[1,:]

    df_reg3_unburnt                  = pd.DataFrame({'Tmax_diff': Tmax_mean_sen_unburnt[2,:] - Tmax_mean_ctl_unburnt[2,:]})
    df_reg3_unburnt['LAI_ctl_mean']  = LAI_mean_ctl_unburnt[2,:]
    df_reg3_unburnt['LAI_sen_mean']  = LAI_mean_sen_unburnt[2,:]
    df_reg3_unburnt['ALB_ctl_mean']  = ALB_mean_ctl_unburnt[2,:]
    df_reg3_unburnt['ALB_sen_mean']  = ALB_mean_sen_unburnt[2,:]
    df_reg3_unburnt['Qle_ctl_mean']  = Qle_mean_ctl_unburnt[2,:]
    df_reg3_unburnt['Qle_sen_mean']  = Qle_mean_sen_unburnt[2,:]
    df_reg3_unburnt['LAI_ctl_low']   = LAI_mean_ctl_unburnt[2,:] - LAI_std_ctl_unburnt[2,:]
    df_reg3_unburnt['LAI_ctl_high']  = LAI_mean_ctl_unburnt[2,:] + LAI_std_ctl_unburnt[2,:]
    df_reg3_unburnt['LAI_sen_low']   = LAI_mean_sen_unburnt[2,:] - LAI_std_sen_unburnt[2,:]
    df_reg3_unburnt['LAI_sen_high']  = LAI_mean_sen_unburnt[2,:] + LAI_std_sen_unburnt[2,:]
    df_reg3_unburnt['ALB_ctl_low']   = ALB_mean_ctl_unburnt[2,:] - ALB_std_ctl_unburnt[2,:]
    df_reg3_unburnt['ALB_ctl_high']  = ALB_mean_ctl_unburnt[2,:] + ALB_std_ctl_unburnt[2,:]
    df_reg3_unburnt['ALB_sen_low']   = ALB_mean_sen_unburnt[2,:] - ALB_std_sen_unburnt[2,:]
    df_reg3_unburnt['ALB_sen_high']  = ALB_mean_sen_unburnt[2,:] + ALB_std_sen_unburnt[2,:]
    df_reg3_unburnt['Qle_ctl_low']   = Qle_mean_ctl_unburnt[2,:] - Qle_std_ctl_unburnt[2,:]
    df_reg3_unburnt['Qle_ctl_high']  = Qle_mean_ctl_unburnt[2,:] + Qle_std_ctl_unburnt[2,:]
    df_reg3_unburnt['Qle_sen_low']   = Qle_mean_sen_unburnt[2,:] - Qle_std_sen_unburnt[2,:]
    df_reg3_unburnt['Qle_sen_high']  = Qle_mean_sen_unburnt[2,:] + Qle_std_sen_unburnt[2,:]
    ...
    if 1:
        ...
        FMI_file_unburnt     = Dataset(FMI_file_unburnt, mode='r')
        Time                 = FMI_file_unburnt.variables['time'][:]
        FMI_ctl_mean_unburnt = FMI_file_unburnt.variables['FMI_ctl_mean'][:]
        FMI_sen_mean_unburnt = FMI_file_unburnt.variables['FMI_sen_mean'][:]
        FMI_ctl_std_unburnt  = FMI_file_unburnt.variables['FMI_ctl_std'][:]
    ...
    # LAI
    row = 1
    axs[row,0].fill_between(time_steps, df_reg1['LAI_ctl_low'].rolling(window=5).mean(), df_reg1['LAI_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,0].fill_between(time_steps, df_reg1['LAI_sen_low'].rolling(window=5).mean(), df_reg1['LAI_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)

    axs[row,0].plot(df_reg1['LAI_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls='-', lw=1, alpha=1)
    axs[row,0].plot(df_reg1['LAI_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls='-', lw=1, alpha=1)

    axs[row,0].plot(df_reg1_unburnt['LAI_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls=':', lw=1, alpha=1)
    axs[row,0].plot(df_reg1_unburnt['LAI_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls=':', lw=1, alpha=1)

    axs[row,1].fill_between(time_steps, df_reg2['LAI_ctl_low'].rolling(window=5).mean(), df_reg2['LAI_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,1].fill_between(time_steps, df_reg2['LAI_sen_low'].rolling(window=5).mean(), df_reg2['LAI_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)

    axs[row,1].plot(df_reg2['LAI_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls='-', lw=1, alpha=1)
    axs[row,1].plot(df_reg2['LAI_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls='-', lw=1, alpha=1)

    axs[row,1].plot(df_reg2_unburnt['LAI_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls=':', lw=1, alpha=1)
    axs[row,1].plot(df_reg2_unburnt['LAI_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls=':', lw=1, alpha=1)

    axs[row,2].fill_between(time_steps, df_reg3['LAI_ctl_low'].rolling(window=5).mean(), df_reg3['LAI_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,2].fill_between(time_steps, df_reg3['LAI_sen_low'].rolling(window=5).mean(), df_reg3['LAI_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)

    axs[row,2].plot(df_reg3['LAI_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls='-', lw=1, alpha=1)
    axs[row,2].plot(df_reg3['LAI_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls='-', lw=1, alpha=1)

    axs[row,2].plot(df_reg3_unburnt['LAI_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls=':', lw=1, alpha=1)
    axs[row,2].plot(df_reg3_unburnt['LAI_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls=':', lw=1, alpha=1)

    # ALB
    row = 2
    axs[row,0].fill_between(time_steps, df_reg1['ALB_ctl_low'].rolling(window=5).mean(), df_reg1['ALB_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,0].fill_between(time_steps, df_reg1['ALB_sen_low'].rolling(window=5).mean(), df_reg1['ALB_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)

    axs[row,0].plot(df_reg1['ALB_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls='-', lw=1, alpha=1)
    axs[row,0].plot(df_reg1['ALB_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls='-', lw=1, alpha=1)

    axs[row,0].plot(df_reg1_unburnt['ALB_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls=':', lw=1, alpha=1)
    axs[row,0].plot(df_reg1_unburnt['ALB_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls=':', lw=1, alpha=1)

    axs[row,1].fill_between(time_steps, df_reg2['ALB_ctl_low'].rolling(window=5).mean(), df_reg2['ALB_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,1].fill_between(time_steps, df_reg2['ALB_sen_low'].rolling(window=5).mean(), df_reg2['ALB_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)

    axs[row,1].plot(df_reg2['ALB_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls='-', lw=1, alpha=1)
    axs[row,1].plot(df_reg2['ALB_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange",ls='-', lw=1, alpha=1)

    axs[row,1].plot(df_reg2_unburnt['ALB_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls=':', lw=1, alpha=1)
    axs[row,1].plot(df_reg2_unburnt['ALB_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange",ls=':', lw=1, alpha=1)

    axs[row,2].fill_between(time_steps, df_reg3['ALB_ctl_low'].rolling(window=5).mean(), df_reg3['ALB_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,2].fill_between(time_steps, df_reg3['ALB_sen_low'].rolling(window=5).mean(), df_reg3['ALB_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)

    axs[row,2].plot(df_reg3['ALB_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls='-', lw=1, alpha=1)
    axs[row,2].plot(df_reg3['ALB_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange",ls='-', lw=1, alpha=1)

    axs[row,2].plot(df_reg3_unburnt['ALB_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls=':', lw=1, alpha=1)
    axs[row,2].plot(df_reg3_unburnt['ALB_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange",ls=':', lw=1, alpha=1)

    # Qle
    row = 3
    axs[row,0].fill_between(time_steps, df_reg1['Qle_ctl_low'].rolling(window=5).mean(), df_reg1['Qle_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,0].fill_between(time_steps, df_reg1['Qle_sen_low'].rolling(window=5).mean(), df_reg1['Qle_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)

    axs[row,0].plot(df_reg1['Qle_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls='-', lw=1, alpha=1)
    axs[row,0].plot(df_reg1['Qle_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls='-', lw=1, alpha=1)

    axs[row,0].plot(df_reg1_unburnt['Qle_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls=':', lw=1, alpha=1)
    axs[row,0].plot(df_reg1_unburnt['Qle_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls=':', lw=1, alpha=1)

    axs[row,1].fill_between(time_steps, df_reg2['Qle_ctl_low'].rolling(window=5).mean(), df_reg2['Qle_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,1].fill_between(time_steps, df_reg2['Qle_sen_low'].rolling(window=5).mean(), df_reg2['Qle_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)

    axs[row,1].plot(df_reg2['Qle_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls='-', lw=1, alpha=1)
    axs[row,1].plot(df_reg2['Qle_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls='-', lw=1, alpha=1)

    axs[row,1].plot(df_reg2_unburnt['Qle_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls=':', lw=1, alpha=1)
    axs[row,1].plot(df_reg2_unburnt['Qle_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls=':', lw=1, alpha=1)

    axs[row,2].fill_between(time_steps, df_reg3['Qle_ctl_low'].rolling(window=5).mean(), df_reg3['Qle_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,2].fill_between(time_steps, df_reg3['Qle_sen_low'].rolling(window=5).mean(), df_reg3['Qle_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)

    axs[row,2].plot(df_reg3['Qle_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls='-', lw=1, alpha=1)
    axs[row,2].plot(df_reg3['Qle_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls='-', lw=1, alpha=1)

    axs[row,2].plot(df_reg3_unburnt['Qle_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", ls=':', lw=1, alpha=1)
    axs[row,2].plot(df_reg3_unburnt['Qle_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", ls=':', lw=1, alpha=1)
...
def plot_time_series_burn_region(FMI_file, Tmax_file, LAI_file, ALB_file, Qle_file, loc_lats=None, loc_lons=None, time_s=None, time_e=None):
    ...
    axs[row,0].fill_between(time_steps, df_reg1['LAI_sen_low'].rolling(window=5).mean(), df_reg1['LAI_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)
    axs[row,0].plot(df_reg1['LAI_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", lw=1, alpha=1)
    axs[row,0].plot(df_reg1['LAI_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", lw=1, alpha=1)

    axs[row,1].fill_between(time_steps, df_reg2['LAI_ctl_low'].rolling(window=5).mean(), df_reg2['LAI_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,1].fill_between(time_steps, df_reg2['LAI_sen_low'].rolling(window=5).mean(), df_reg2['LAI_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)
    axs[row,1].plot(df_reg2['LAI_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", lw=1, alpha=1)
    axs[row,1].plot(df_reg2['LAI_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", lw=1, alpha=1)

    axs[row,2].fill_between(time_steps, df_reg3['LAI_ctl_low'].rolling(window=5).mean(), df_reg3['LAI_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,2].fill_between(time_steps, df_reg3['LAI_sen_low'].rolling(window=5).mean(), df_reg3['LAI_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)
    axs[row,2].plot(df_reg3['LAI_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", lw=1, alpha=1)
    axs[row,2].plot(df_reg3['LAI_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", lw=1, alpha=1)
    ...
    axs[row,0].fill_between(time_steps, df_reg1['ALB_sen_low'].rolling(window=5).mean(), df_reg1['ALB_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)
    axs[row,0].plot(df_reg1['ALB_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", lw=1, alpha=1)
    axs[row,0].plot(df_reg1['ALB_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", lw=1, alpha=1)

    axs[row,1].fill_between(time_steps, df_reg2['ALB_ctl_low'].rolling(window=5).mean(), df_reg2['ALB_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,1].fill_between(time_steps, df_reg2['ALB_sen_low'].rolling(window=5).mean(), df_reg2['ALB_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)
    axs[row,1].plot(df_reg2['ALB_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", lw=1, alpha=1)
    axs[row,1].plot(df_reg2['ALB_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", lw=1, alpha=1)

    axs[row,2].fill_between(time_steps, df_reg3['ALB_ctl_low'].rolling(window=5).mean(), df_reg3['ALB_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,2].fill_between(time_steps, df_reg3['ALB_sen_low'].rolling(window=5).mean(), df_reg3['ALB_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)
    axs[row,2].plot(df_reg3['ALB_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", lw=1, alpha=1)
    axs[row,2].plot(df_reg3['ALB_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", lw=1, alpha=1)
    ...
    axs[row,0].fill_between(time_steps, df_reg1['Qle_sen_low'].rolling(window=5).mean(), df_reg1['Qle_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)
    axs[row,0].plot(df_reg1['Qle_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", lw=1, alpha=1)
    axs[row,0].plot(df_reg1['Qle_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", lw=1, alpha=1)

    axs[row,1].fill_between(time_steps, df_reg2['Qle_ctl_low'].rolling(window=5).mean(), df_reg2['Qle_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,1].fill_between(time_steps, df_reg2['Qle_sen_low'].rolling(window=5).mean(), df_reg2['Qle_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)
    axs[row,1].plot(df_reg2['Qle_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", lw=1, alpha=1)
    axs[row,1].plot(df_reg2['Qle_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", lw=1, alpha=1)

    axs[row,2].fill_between(time_steps, df_reg3['Qle_ctl_low'].rolling(window=5).mean(), df_reg3['Qle_ctl_high'].rolling(window=5).mean(),
                    color="green", edgecolor="none", alpha=0.2)
    axs[row,2].fill_between(time_steps, df_reg3['Qle_sen_low'].rolling(window=5).mean(), df_reg3['Qle_sen_high'].rolling(window=5).mean(),
                    color="orange", edgecolor="none", alpha=0.35)
    axs[row,2].plot(df_reg3['Qle_ctl_mean'].rolling(window=5).mean(), label="ctl", c = "green", lw=1, alpha=1)
    axs[row,2].plot(df_reg3['Qle_sen_mean'].rolling(window=5).mean(), label="exp", c = "orange", lw=1, alpha=1)
