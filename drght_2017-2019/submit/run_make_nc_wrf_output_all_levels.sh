...
var_names=("wa" "z" "ua" "va" "th" "rh" "PBLH" "p" "td2" "T2" "rh2" "slp" "pw" "cloudfrac" "cape_2d" "tc" )
...
rm wrfout_201701-202002.nc
rm -r tmp.nc_compress
nccompress -r -o -np 8 wrfout_201912-202002.nc
...
cd /g/data/w97/mm3972/model/wrf/NUWRF/LISWRF_configs/Tinderbox_drght_LAI_ALB/${case_name}/WRF_output/${var_name}
rm -r tmp.nc_compress
nccompress -r -o -np 8 wrfout_201701-202006.nc
