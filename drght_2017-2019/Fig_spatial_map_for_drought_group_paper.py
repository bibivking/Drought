...
def plot_spatial_fwsoil_qle_qh_tmax_qair(land_1201_path, land_clim_path, wrf_path, shape_path = None,
            ...
            if j == 0:
                ...
                if i == 0:
                    ax[i,j].text(-0.36, 0, "Summer", va='bottom', ha='center',
                                  ...
                                  transform=ax[i,j].transAxes)
                    ax[i,j].text(-0.36, -2, "Heatwave", va='bottom', ha='center',
                                  rotation='vertical', rotation_mode='anchor',fontsize=14,
                                  transform=ax[i,j].transAxes)
    ...
    plt.savefig('./plots/spatial_map_fwsoil_Qle_Qh_Tmax_q_2018_2020_summer_HW.png',dpi=300)


def plot_spatial_sm_qle_qh_tmax_qair(land_1201_path, land_clim_path, wrf_path, shape_path = None,
                                         loc_lat=None, loc_lon=None, seconds=None, message=None):
...
if __name__ == "__main__":
    ...
    atmo_clim_path = "/g/data/w97/mm3972/model/wrf/NUWRF/LISWRF_configs/"+case_clim+"/WRF_output/"

    # plot_spatial_Rnet_LW_SW(land_1201_path, land_clim_path, atmo_1201_path, atmo_clim_path, wrf_path, shape_path)
    # plot_spatial_fwsoil_qle_qh_tmax_qair(land_1201_path, land_clim_path, wrf_path, shape_path, loc_lat=loc_lat, loc_lon=loc_lon)

    plot_spatial_sm_qle_qh_tmax_qair(land_1201_path, land_clim_path, wrf_path, shape_path, loc_lat=loc_lat, loc_lon=loc_lon)
