...
def spital_map_temperal_metrics(wrf_path, obs_path, obs_name, file_paths, var_name, time_s, time_e,
    ...
    if var_name in ['t2m','tas','Tair','Tair_f_inst']:
        ...
        obs    = Obs_regrid*24*60*60.*3 # for AWAP 3 hourly data
...
def plot_map_temperal_metrics(wrf_path, obs_path, obs_name, file_paths, var_name, time_s, time_e,
    ...
    if var_name in ['t2m','tas','Tair','Tair_f_inst']:
        ...
        clevs1 = np.arange( 0.,1010.,20.)
        clevs2 = np.arange( 0.,1010.,20.)
        clevs3 = np.arange( 0.0,520, 20.)
        clevs4 = [-50,-45,,-40,-35,-30,-25,-20,-15,-10,-5,5,10,15,20,25,30,35,40,45,50]
        clevs5 = [-5,-4,-3,-2,-1,1,2,3,4,5]
        #[-1,-0.8,-0.6,-0.4,-0.2,0.2,0.4,0.6,0.8,1.]
        clevs6 = [-5,-4,-3,-2,-1,1,2,3,4,5]
