...
if __name__ == "__main__":
    ...
    if 1:
        ...
        file_paths_ctl = [ LIS_path_ctl+"LIS.CABLE.201701-202006_temp.nc" ]

        file_paths_sen = [ LIS_path_sen+"LIS.CABLE.201701-202006_temp.nc" ]

        file_paths_sen_2=None

        # =============== save pixels  ================
        if 1:
            var_names      = ["AvgSurfT_tavg","VegT_tavg"] # temperature
