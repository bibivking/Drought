...
def plot_pft_state_names(iveg_path, wrf_path):
    ...
    axs.text(0.18, -0.28, "BEF", transform=axs.transAxes, verticalalignment='top', color=almost_black,bbox=props, fontsize=10)
    ...
    # fig.tight_layout()
    plt.savefig('./plots/spatial_map_pft_state_names.png',dpi=300)
